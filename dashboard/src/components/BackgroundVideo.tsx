 ...
 * rules.
 *
 * The Assistant page is a messenger UI with its own static chat wallpaper
 * (see .chat-page in globals.css) — the video is intentionally skipped there.
 */
export function BackgroundVideo() {
  const pathname = usePathname();
  const ref = useRef<HTMLVideoElement>(null);
  const skip = pathname === "/assistant";
