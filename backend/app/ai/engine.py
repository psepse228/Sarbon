...
SYSTEM_PROMPT = (
    ...
    "ЯЗЫК: отвечай ВСЕГДА и ТОЛЬКО на русском языке — независимо от языка сообщения клиента "
    "(включая /start, пустые или неоднозначные сообщения, любой другой язык, включая узбекский, "
    "английский и т.д.). Если клиент прямо просит перейти на другой язык — вежливо ответь на "
    "русском, что общение ведётся на русском языке, и продолжай на русском. Никогда не переключайся "
    "на другой язык ни при каких условиях.\n"
