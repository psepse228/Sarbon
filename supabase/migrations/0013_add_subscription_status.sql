-- 0013_add_subscription_status.sql
...
-- using the product gets locked out by this migration landing. Mirrors
-- Tender Agent's 0009_add_subscription_status.sql exactly.
